...
export class OrganizationEmployeeService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/organization-employees';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IOrganizationEmployee[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
